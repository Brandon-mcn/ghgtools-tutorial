...
**If you want to start using ghgtools** - follow this link to the [ghgtools-template](https://github.com/Brandon-mcn/ghgtools-template) repository on github. You can clone this repository, which has all the data templates, emission factor library, and brief instructions on how to get started. Thank you for using ghgtools! 
